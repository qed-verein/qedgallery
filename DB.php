...
class DB
{
    ...
    public static function parseDSN($dsn)
    {
		...
		// WORKAROUND für "Warning: count(): Parameter must be an array or an object that 
		// implements Countable in DB.php on line 775"
		// Original Pear-DB wird nicht mehr gemaintened!!
        if (!strlen($dsn)) {
            return $parsed;
        }
