...
require_once('views/upload_form_alt.php');
...
if(isset($_POST['upload']))
{
	try
	{
		if($_FILES['image']['name'] == '')
			throw new InvalidInputException("Es wurde keine Datei angegeben");
		...
		$layout->content = formatInformation("Die Bilder wurden hochgeladen", urlAlbumView($album->id));
